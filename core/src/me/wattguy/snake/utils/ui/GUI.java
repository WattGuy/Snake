...
public class GUI {
    ...
    public GUI(){
        ...
        menu.setPosition(GButtons.menu_x + (GButtons.menu_width / 2), GButtons.menu_y + (GButtons.menu_height / 2), Align.center);
        ...
        pause.setPosition(GButtons.pause_x + (GButtons.pause_width / 2), GButtons.pause_y + (GButtons.pause_height / 2), Align.center);
        ...
        lscore.setPosition(GButtons.menu_x + GButtons.menu_width + (GButtons.abyss / 2), GButtons.menu_y + (GButtons.menu_height / 2) + ((Info.SPACE_TOP / 20) * 3), Align.center);
        ...
        score.setPosition(GButtons.menu_x + GButtons.menu_width + (GButtons.abyss / 2), GButtons.menu_y + (GButtons.menu_height / 2) - ((Info.SPACE_TOP / 20) * 3), Align.center);
